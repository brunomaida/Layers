...
(function (root) {
  ...
  // Arquivo de export/import. Handles de pasta ficam de fora por construcao: FileSystemHandle
  // nao e serializavel, e por isso o import avisa que pasta local precisa ser reconectada.
  function exportConfig(cfg) {
    return {
      ...
      session: cfg.session || emptySession()
    };
  }
